<template>
  <ul>
    ...
    >
      <a
        class="post-cover w-full lg:w-3/5 text-center"
        :href="toLink(post)"
        :title="post?.title"
      >
        <img
          class="w-full h-auto rounded-b-none lg:rounded-xl"
          :src="homeThumbnail(post?.meta.cover)"
      ...
      >
        ...
        <span class="" v-for="tag in post?.meta?.tags" :key="tag">
          <a :href="`/tags/${tag}/`">
            {{ tag }}
          </a>
        </span>
        ...
        <p class="post-meta">
          <span
            class="leancloud_visitors my-6"
            id="/2021/09/12/吾爱吾师-吾更爱真理/_visitors"
          >
            <i class="fa fa-eye"></i>
            热度
          ...
          <span
            class="leancloud_likes"
            id="/2021/09/12/吾爱吾师-吾更爱真理/_likes"
            data-url="/2021/09/12/吾爱吾师-吾更爱真理/"
          >
