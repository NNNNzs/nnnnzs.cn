<template>
  <div ref="elRef" class="snap-y snap-mandatory">
    <Banner class="snap-start" />
    <PostCard :posts="postList" class="snap-start" />
    <div
      class="WenYueQingLongTi cursor-pointer text-center text-slate-950 dark:text-white"
      @click="loadMore"
    >
      加载更多
    </div>
